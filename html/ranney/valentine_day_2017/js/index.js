...
//var stats;
maxStageWidth = window.innerWidth
maxStageHeight = window.innerHeight
...
//========================
    ...
    function startDemo(){
        ...
        var logoText = "王二口的情人节";
        if(!logoCanvas){
            logoCanvas = document.createElement("canvas");
            logoCanvasBG = document.createElement("canvas");
        }
        createLogo("王二口的情人节", logoCanvas, logoCanvasBG);
        if(!gameOverCanvas){
    ...
    function updateScore(){
		...
		if(score >= 8)
		{
		    window.location.href=window.location.href + "flower_gift/index.html";
		}
        ffScoreBugFix++;
    }
